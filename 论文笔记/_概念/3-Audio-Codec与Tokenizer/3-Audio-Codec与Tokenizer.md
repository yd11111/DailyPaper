...
---
# 概念目录页：3-Audio-Codec与Tokenizer

用于浏览概念笔记和对应分类入口。

- 当前目录：`3-Audio-Codec与Tokenizer`

## 当前目录笔记

- [[论文笔记/_概念/3-Audio-Codec与Tokenizer/Acoustic Token|Acoustic Token]]
- [[论文笔记/_概念/3-Audio-Codec与Tokenizer/Acoustic Tokenizer|Acoustic Tokenizer]]
...
- [[论文笔记/_概念/3-Audio-Codec与Tokenizer/Codec Merging|Codec Merging]]
...
- [[论文笔记/_概念/3-Audio-Codec与Tokenizer/Factorized Vector Quantization|Factorized Vector Quantization]]
- [[论文笔记/_概念/3-Audio-Codec与Tokenizer/FlexiCodec|FlexiCodec]]
